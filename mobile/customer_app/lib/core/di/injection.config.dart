...
import '../../features/cart/domain/cart_bloc.dart' as _i103;
import '../network/dio_client.dart' as _i200;
import '../storage/storage_service.dart' as _i300;

extension GetItInjectableX on _i174.GetIt {
  // initialises the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    // Cart
    gh.factory<_i103.CartBloc>(() => _i103.CartBloc());
